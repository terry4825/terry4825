# 📊 Hyunkyu Yi | Data Science & Software Engineering Portfolio
...
### [1. UAM Optimal Path Generation Simulation (C++)](./UAM_Project.md)
...
### [2. AI-based Legal Data Analysis & Improvement Strategy](./Legal_Project.md)
...
### [3. U.S. Oil Market Consumption & Production Forecasting](./STAT429_Project.md)
...
### [4. Clustering Analysis of Cocaine Abuse Patterns](./STAT437_Project.md)
...
### [5. Multivariate Analysis of Liver Disease (ILPD) using SAS](./STAT448_Project.md)
* **Keyword:** #Advanced_Statistics #SAS #Logistic_Regression #Medical_Data
* **Summary:** Performed comprehensive clinical data analysis on 583 patients. Demonstrated proficiency in **SAS** through logistic regression, ANOVA, and stepwise variable selection.
...
* **University of Illinois Urbana-Champaign (UIUC)**
  * B.S. in Statistics
  * Focused on Advanced Data Analysis and Time Series Methods
