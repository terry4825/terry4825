...
반갑습니다! 복잡한 데이터 속에서 통계적 근거를 바탕으로 최적의 해답을 찾아내는 이현규입니다. 고급 통계 분석 방법론과 강화학습을 활용한 알고리즘 최적화에 강점을 가지고 있습니다.
...
* **Specialties:** 강화학습(Q-Learning), 예측 모델링 및 모델 검증, 통계적 데이터 진단
...
## 💼 경력 사항
* **소프트웨어 개발 인턴 | 모아소프트** (2023.06 - 2023.12)
  * C++ 기반 UAM 경로 생성 강화학습 시뮬레이션 로직 및 GUI 개발.
