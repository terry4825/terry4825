...
## 🚀 자기소개
* 🎓 **UIUC (University of Illinois Urbana-Champaign)** 통계학 학사 졸업
* 💻 **IT 강소기업 SW 개발 인턴** | UAM 시나리오 및 강화학습 시뮬레이션 개발
* 📊 **Data & Dev Hybrid** | **R, SAS** 기반 통계 분석 및 C++, Python 알고리즘 구현 역량 보유
* 🛡️ **Verification-Oriented** | 직관을 넘어 수치적 근거와 엄격한 설계 기준을 준수하는 개발을 지향합니다.
...
### 📊 통계 분석 및 머신러닝 (Statistical Analysis & ML)
